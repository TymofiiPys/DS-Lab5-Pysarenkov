...
а) **(Java з використанням стандартної бібліотеки)** Завдання про новобранців. Множині новобранців дається команда «наліво»
...
б) **(Java з використанням самостійної реалізації бар'єра)** Створити додаток з чотирма потоками. Кожен потік працює
